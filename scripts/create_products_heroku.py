#!/usr/bin/env python3
"""
Script to create products from predefined terms on Heroku.
"""
...
def main():
    """Main function to process predefined search terms."""
    app = create_app()
    
    with app.app_context():
        print("🎨 Product Creator - Predefined Terms")
        print("=" * 50)
        
        # Your predefined terms
        terms = [
            "sza shirt",
            "hustle ninjas", 
            "hustle gang",
            ...
            "dissection t shirt",
            "sorry ladies im pregnant shirt",
            "thirty single clothing",
            "pink floyd shirt",
            "whoppa wit da choppa shirt",
            "meme t shirt",
            "sza shirt",
            "sturniolo merch",
            "ramones t shirt",
        ...
        print(f"📝 Processing {len(terms)} predefined terms...")
        print("-" * 30)
